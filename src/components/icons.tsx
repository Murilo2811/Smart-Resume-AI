...
export const BrainIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        ...
        <path d="M12 15a2.5 2.5 0 0 0 2.5-2.5V7.5A2.5 2.5 0 0 0 12 5" />
        <path d="M12 15a2.5 2.5 0 0 1-2.5-2.5V7.5A2.5 2.5 0 0 1 12 5" />
        <path d="M4.5 12A2.5 2.5 0 0 0 7 9.5h0A2.5 2.5 0 0 0 9.5 12" />
        <path d="M19.5 12a2.5 2.5 0 0 1-2.5-2.5h0A2.5 2.5 0 0 1 14.5 12" />
    </svg>
);
...
export const PdfIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        ...
        <path d="M4 12h3a2 2 0 0 1 2 2v2a2 2 0 0 1-2 2H4v-6Z"/>
        <path d="M4 18h1"/>
        <path d="M12 18h2a2 2 0 0 0 2-2v-2a2 2 0 0 0-2-2h-2v6Z"/>
        <path d="M12 15h2"/>
        <path d="M17 18h3"/>
        <path d="M17 15h3"/>
        <path d="M10 9H8"/>
        <path d="M17.5 22H6a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h8l6 6v10a2 2 0 0 1-2 2Z"/>
    </svg>
);